package com.oboegakivps.models.service;
...
import com.oboegakivps.models.bean.Store;
import com.oboegakivps.models.dao.PasswordDAO;
import com.oboegakivps.models.dao.ProductDAO;
import com.oboegakivps.models.dao.SalesDAO;

import jakarta.servlet.http.HttpSession;

/**
 * 店内オペレーションビジネスロジッククラス
 */
public class Operation {
    ...
    private boolean authenticate(String userId, String password) throws Exception {
        ...
        if (password.equals("") && dbPass.equals("")) {
            ...
            //比較結果の設定
            result = PasswordHasherLogic.checkPassword(password, dbPass);
        }
    ...
    private Store makeStore() throws Exception {
        ...
        // 店舗情報作成
        Store store = new Store("TODO-1-No1(MVC-SHOP)", list);
    ...
    public void chgPassword(String userId, String password) throws Exception {
        ...
        String hashedPassword = PasswordHasherLogic.hashPassword(password);
